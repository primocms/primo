...
<div class="codemirror-container" style="{style}">
  ...
  {#if docs}
    <a in:fade={{ duration: 200 }} target="blank" href="{docs}" class="callout text-xs pointer-events-auto flex items-center absolute bottom-0 right-0 h-auto text-white bg-primored py-1 px-3 m-1 hover:bg-gray-200 transition-colors duration-200">
