...
<div class="codemirror-container" style="{style}">
  ...
  {#if docs}
    <a in:fade={{ duration: 200 }} target="blank" href="{docs}" class="z-10 text-xs pointer-events-auto flex items-center absolute bottom-0 right-0 h-auto text-gray-100 py-1 px-3 m-1 hover:bg-gray-600 transition-colors duration-200">
...
<style global>
  ...
  .CodeMirror-foldmarker {
    @apply cursor-pointer rounded-full bg-gray-600 transition-colors duration-200;
    padding: 4px 6px;
