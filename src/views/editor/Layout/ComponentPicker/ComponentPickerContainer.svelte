...
<div
  class="component-wrapper flex flex-col shadow-xl text-white rounded"
  ...
  <div class="shadow-sm component-header">
    <p class="component-label text-xs font-medium ml-1"><span>{title}</span></p>
    <div class="flex">
      {#each buttons as button}
        <button
          class="p-2 flex space-x-2 items-center"
          class:bg-primored={button.highlight}
