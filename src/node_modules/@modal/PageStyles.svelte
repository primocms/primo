<script>
  ...
  import {content,settings,site,tailwind} from '@stores/data'
  ...
  let unprocessedStyles = globalStyles.uncompiled || '';
  let processedStyles = globalStyles.compiled || ''; 
  let moduleTailwindConfig = globalStyles.tailwindConfig || defaultTw;
  ...
  $: {
    globalStyles = {
      compiled: processedStyles,
      uncompiled: unprocessedStyles,
      tailwindConfig
    }
