    ...
    <li transition:fade={{ duration: 200 }} id="page-{page.id}">
      <div class="shadow-xl mb-4 rounded">
        ...
        <div class="w-full flex justify-between px-3 py-2 border-t border-gray-100 ">
          <h3 class="text-xs font-semibold text-gray-700">{page.title}</h3>
          <div class="flex justify-end">
            {#if page.id !== 'index'}
              <button on:click={() => deletePage(page.id)} class="delete-page text-xs text-red-500 hover:text-red-700">
