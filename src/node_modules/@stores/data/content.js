...
import { getUniqueId, updateInstancesInContent } from 'utils'
import {updatePage,getPageData} from '@fb/firestore/domains'
...
export default {
  save: () => {
    // updatePage({ content: get(store) })
    site.saveContent(get(store))
  },
  refresh: async () => {
